    ...
    sidebar: [
      {
        text: 'Important',
        items: [
          { text: 'Laws', link: '/legal' },
          { text: 'Stores', link: '/stores' },
          { text: 'Maps', link: '/map' },
          { text: 'GPS spoofing', link: '/gps-spoofing' },
          { text: 'Fly together', link: '/how-to-fly-together' },
        ]
      },
      {
        text: 'Guides',
        items: [
          { text: 'Getting started', link: '/guides/neophyte' },
          { text: 'First fly', link: '/guides/first-flight' },
          { text: 'Buy LiPo', link: '/guides/lipo-transfer' },
          { text: 'Travel with LiPo', link: '/guides/lipo-flight' },
          { text: 'Disposal LiPo', link: '/guides/lipo-disposal'},
        ]
      },
      {
        text: 'Other',
        items: [
          { text: 'Videos', link: '/other/creators' }
        ]
      }
    ],
